...
#import "TESTPholarztImagesResponse.h"

/**
 The service client object.
 */
@interface TESTPholarztapiClient: AWSAPIGatewayClient
 ...
 *Swift*
     ...
     let serviceClient = TESTPholarztapiClient.defaultClient()

 *Objective-C*

     TESTPholarztapiClient *serviceClient = [TESTPholarztapiClient defaultClient];
 ...
 *Swift*
     ...
     func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
         ...
         TESTPholarztapiClient.registerClientWithConfiguration(configuration, forKey: "USWest2TESTPholarztapiClient")
 ...
 *Swift*
     ...
     let serviceClient = TESTPholarztapiClient(forKey: "USWest2TESTPholarztapiClient")

 *Objective-C*

     TESTPholarztapiClient *serviceClient = [TESTPholarztapiClient clientForKey:@"USWest2TESTPholarztapiClient"];
...
/**
 ...
 return type: TESTPholarztImagesResponse *
 */
- (AWSTask *)rootPost:(TESTPholarztImagesRequest *)body;
