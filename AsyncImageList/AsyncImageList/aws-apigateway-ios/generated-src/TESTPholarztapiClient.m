...
@interface TESTPholarztapiClient()
...
@implementation TESTPholarztapiClient
...
+ (instancetype)defaultClient {
    ...
    static TESTPholarztapiClient *_defaultClient = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _defaultClient = [[TESTPholarztapiClient alloc] initWithConfiguration:serviceConfiguration];
    });
...
+ (void)registerClientWithConfiguration:(AWSServiceConfiguration *)configuration forKey:(NSString *)key {
    ...
    [_serviceClients setObject:[[TESTPholarztapiClient alloc] initWithConfiguration:configuration]
                        forKey:key];
}
...
- (instancetype)initWithConfiguration:(AWSServiceConfiguration *)configuration {
    if (self = [super init]) {
        ...
        NSString *URLString = @"https://y3zhm4ntme.execute-api.ap-northeast-1.amazonaws.com/prod2";
...
- (AWSTask *)rootPost:(TESTPholarztImagesRequest *)body {
    ...
    return [self invokeHTTPRequest:@"POST"
                  ...
                  headerParameters:headerParameters
                              body:body
                     responseClass:[TESTPholarztImagesResponse class]];
}
